...
public class GlobalExceptionHandler {
    ...
    public Result handleValidException(MethodArgumentNotValidException e) {
        return new Result(ResultCode.BAD_REQUEST.code, ResultCode.BAD_REQUEST.message);
    }
    ...
    public Result  handleAllException(Exception e) {
        e.printStackTrace();
        return new Result(ResultCode.INTERNAL_ERROR.code, ResultCode.INTERNAL_ERROR.message);
    }
}
